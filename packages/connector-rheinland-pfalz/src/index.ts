// Landtag Rheinland-Pfalz: no adapter of its own yet.
//
...
// package exists so that when rheinland-pfalz gets its own adapter, there is already a
...
export const PARLIAMENT = "rheinland-pfalz" as const;
export const LABEL = "Landtag Rheinland-Pfalz";
