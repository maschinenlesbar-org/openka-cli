...
import type { AnsweredBy, DocumentType } from "@maschinenlesbar.org/openka-lib-models";
import { parseGermanDate, parseUrheber } from "@maschinenlesbar.org/openka-lib-extract";
import { childText, childrenNamed, streamElements, type XmlNode } from "@maschinenlesbar.org/openka-lib-source";
import type { DocRef, DocRefDocument } from "@maschinenlesbar.org/openka-lib-source";
