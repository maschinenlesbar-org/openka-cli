// Schleswig-Holsteinischer Landtag: no adapter of its own yet.
//
...
// package exists so that when schleswig-holstein gets its own adapter, there is already a
...
export const PARLIAMENT = "schleswig-holstein" as const;
export const LABEL = "Schleswig-Holsteinischer Landtag";
