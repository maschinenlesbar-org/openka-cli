// Hessischer Landtag: no adapter of its own yet.
//
...
// package exists so that when hessen gets its own adapter, there is already a
...
export const PARLIAMENT = "hessen" as const;
export const LABEL = "Hessischer Landtag";
