# @maschinenlesbar.org/openka-connector-hessen

> Hessischer Landtag — reachable today, no adapter of its own yet.

This package exists so the gap is a **place** rather than an absence.
Hessischer Landtag delivers
...
| | |
|---|---|
| parliament key | `hessen` |
| Herkunft code | `HES` — how the Parlamentsspiegel export format identifies this Land |
