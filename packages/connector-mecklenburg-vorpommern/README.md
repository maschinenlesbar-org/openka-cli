...
> Landtag Mecklenburg-Vorpommern — reachable today, no adapter of its own yet.

This package exists so the gap is a **place** rather than an absence.
Landtag Mecklenburg-Vorpommern delivers
...
| | |
|---|---|
| parliament key | `mecklenburg-vorpommern` |
| Herkunft code | `MEVO` — how the Parlamentsspiegel export format identifies this Land |
