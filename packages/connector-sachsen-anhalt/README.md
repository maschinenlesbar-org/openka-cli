...
> Landtag von Sachsen-Anhalt — reachable today, no adapter of its own yet.

This package exists so the gap is a **place** rather than an absence.
Landtag von Sachsen-Anhalt delivers
...
| | |
|---|---|
| parliament key | `sachsen-anhalt` |
| Herkunft code | `SACA` — how the Parlamentsspiegel export format identifies this Land |
