// Hamburgische Bürgerschaft: no adapter of its own yet.
//
...
// package exists so that when hamburg gets its own adapter, there is already a
...
export const PARLIAMENT = "hamburg" as const;
export const LABEL = "Hamburgische Bürgerschaft";
